...
class Pipe:
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.pipeline.add(src := Gst.ElementFactory.make("appsrc", None))
        ...
        if False:
            ...
            src.link_filtered(vconv, Gst.Caps.from_string(CAPS))

        alvl.link(asnk)
        src.link_filtered(gsnk, Gst.Caps.from_string(CAPS))
